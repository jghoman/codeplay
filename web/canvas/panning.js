window.onload = function() {
    ...
    const runner = {
        ...
        draw:function() {
            ...
            context.drawImage(runnerImg, this.currentFrame * this.frameWidth, 0, this.frameWidth, this.frameHeight, this.x - camera.cameraX, this.y - camera.cameraY, this.frameWidth, this.frameHeight);
        },
    ...
    Promise.all([loadImage(bgImg), loadImage(runnerImg)]).then(() =>
    { gameLoop(); });
